...
public class ViewEmployee extends JFrame implements ActionListener
{
	...
	public ViewEmployee(String userId)
	{
		...
		phoneTF1.setBounds(400, 250, 40, 30);
		phoneTF1.setEnabled(false);
		panel.add(phoneTF1);
		
		phoneTF2 = new JTextField();
		phoneTF2.setBounds(440, 250, 85, 30);
		panel.add(phoneTF2);
	...
	public void loadFromDB()
	{
		...
		String query = "SELECT `userName`, `phone_no`, `role`, `salary` FROM `employee` WHERE `userId`='"+loadId+"';";     
        Connection con=null;
        Statement st = null;
		ResultSet rs = null;
	...
	public void updateInDB()
	{
		...
		double salary=0.0;
		String query = "UPDATE employee SET userName='"+eName+"', Phone_no = '"+phnNo+"', role = '"+role+"', salary = "+salary+" WHERE userId='"+newId+"'";	
