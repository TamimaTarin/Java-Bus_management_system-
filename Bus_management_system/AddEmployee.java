...
public class AddEmployee extends JFrame implements ActionListener
{
	...
	{
		super("Bus Management System - Add New Employee");
		...
		String []items = {"Employee", "Customer"};
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			ManagerHomePage me = new ManagerHomePage(userId);
			me.setVisible(true);
	...
	public void insertIntoDB()
	{
		...
		String query1 = "INSERT INTO employee(userId, userName, phone_no, role,salary) VALUES ('"+newId+"','"+eName+"','"+ phnNo+"','"+role+"',"+salary+");";
		String query2 = "INSERT INTO login(userId,password,status) VALUES ('"+newId+"','"+newPass+"',"+status+");";
